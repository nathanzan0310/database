...
/**
  ...
  * address of the parent of the target node. If the target node is not found, then
  * the location pointed to by parentpp is set to the address of what would be the
...
/**
  ...
  * that node, and returns it in the given result buffer of the given size. Otherwise, 
  * result is filled with "not found".
  */
